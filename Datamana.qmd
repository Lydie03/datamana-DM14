...
death_air_pollution_unique <- death_air_pollution_unique |> 
...
Merged_data <-  DALYs %>%
  ...
  inner_join(death_air_pollution_unique, by = c("Country"))%>% 
...
ggplot(Merged_data, aes(x = Mean_GDP, y = Mean_Value.x)) +
  geom_point(alpha=0.6) +  # Ajoute les points du nuage
